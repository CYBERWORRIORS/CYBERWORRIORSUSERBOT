...
async def _(event):
    ...
    process = await asyncio.create_subprocess_sCYBER(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [CYBERWORRIORSBOT](t.me/CYBER_Userbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your CYBERWORRIORSBOT server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of CYBERWORRIORSBOT repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your CYBERWORRIORSBOT server'
).add_command(
