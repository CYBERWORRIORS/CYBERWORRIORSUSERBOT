...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/CYBERWORRIORS/CYBERWORRIORSBOT) to open this 🔥**Lit AF!!**🔥 __CYBERWORRIORSBOT__ Repo.. Join channel :- @CYBER_Userbot")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the CYBER" + "ツ")
