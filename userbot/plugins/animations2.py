...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](CYBERWORRIORS/CYBERWORRIORSBOT)**",
        ...
        "__INFO:CYBERWORRIORSBOT:Logged in as 557667062__",
        "__INFO:CYBERWORRIORSBOT:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
