...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Please make sure your Heroku API Key, Your App name are configured correctly in the heroku\n\n[Visit Support Group For Help](https://t.me/CYBERSupport)"
        )
    CYBER_data = app.get_log()
    CYBER_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": CYBER_data})
        .json()
        .get("result")
        .get("key")
    )
    CYBER_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{CYBER_key}) && [RAW PAGE](https://nekobin.com/raw/{CYBER_key}) ⚡"
