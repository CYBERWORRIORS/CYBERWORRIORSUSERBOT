...
@CYBERWORRIORSBOT.on(admin_cmd(pattern=r"unpack", outgoing=True))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
