...
from CYBERWORRIORSBOT.Config import Config
from CYBERWORRIORSBOT.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="fban ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="unfban ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern=r"fadd ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern=r"fremove ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="fgroups"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="fsearch ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {CYBER_input}")
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="renamefed ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    CYBER_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {CYBER_input}")
              response = await response 
          except YouBlockedUserError: 
...
@CYBERWORRIORSBOT.on(admin_cmd(pattern="fstat ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    CYBER = await event.edit("`Collecting fstat....`")
    thumb = CYBER_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await CYBERWORRIORSBOT.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using CYBERWORRIORSBOT](t.me/CYBER_Userbot) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await CYBER.edit("`Please Unblock` @MissRose_Bot")


@CYBERWORRIORSBOT.on(admin_cmd(pattern="fedinfo ?(.*)"))
@CYBERWORRIORSBOT.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    CYBER = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await CYBER.edit(massive.text + "\n\n**CYBERARY_AF_CYBERWORRIORSBOT**")
        except YouBlockedUserError:
            await CYBER.edit("`Please Unblock` @MissRose_Bot")
