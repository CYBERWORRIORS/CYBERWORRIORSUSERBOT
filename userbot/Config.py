...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "CYBERWORRIORSBOT")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/CYBERWORRIORS/CYBERWORRIORSBOT"
        )
        ...
        EXTRA_CYBERWORRIORSBOT = os.environ.get("EXTRA_CYBERWORRIORSBOT", -1001221881562)
